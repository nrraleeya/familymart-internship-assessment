...
* **[Task 2: Car Counter](./task_2_car_counter/)** - Computer vision vehicle counting script.
* **[Task 3: OCR](./task_3_ocr/)** - Text extraction engine for digital transaction records.
* **[Task 4: Sales Forecasting](./task_4_sales_forecasting/)** - Predictive time-series models.